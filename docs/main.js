...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('closeColorModal').onclick = () => {
    ...
    document.querySelectorAll('.color-btn').forEach(btn => {
        btn.onclick = () => {
            ...
            if (color === 'reset') {
                ...
                viewer.style.setProperty('--model-color', '');
                viewer.removeAttribute('style');
            } else {
                // Appliquer la couleur
                viewer.style.setProperty('--model-color', color);
                // Note: model-viewer ne supporte pas directement le changement de couleur
                // Cette fonctionnalité nécessiterait de modifier le matériau du modèle
