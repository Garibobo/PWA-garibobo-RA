...
const CACHE_NAME = 'garibobo-ra-v1.1';
const ASSETS_TO_CACHE = [
    ...
    './icons/favicon_RA/android-chrome-192x192.png',
    './icons/favicon_RA/android-chrome-512x512.png',
    './icons/favicon_RA/apple-touch-icon.png',
    './icons/favicon_RA/favicon.ico'
];
